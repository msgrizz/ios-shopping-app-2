//
//  ViewControllerForCollection.swift
//  PCShoppingApp
//
...
class ViewControllerForCollection: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate{

    let array = ["FIGHTING","STRATEGY","SPORT"]
